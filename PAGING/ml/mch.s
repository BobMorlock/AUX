...
fpreset:mov.l	&fpnull%,%a0		# a0 points to null state format word
	...
	text	
	# spl commands
	global	spl7,spl6,spl5,spl4,spl3,spl2,spl1,spl0,splx
	global	splnet,splhi,splclock,splimp
...
ffs2%:
	...
	#
	#	Stuff for software interrupt compatability
	#
...
#if	defined(DEBUG) && defined(NFSDEBUG)
	data
	global	nfsdebug
nfsdebug:
	long	0
