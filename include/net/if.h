/*	@(#)if.h 1.12 85/08/27 SMI; from UCB 6.2 83/08/28	*/
...
#define IFF_LOOPBACK	0x400		/* is a loopback net (defined 0x8 in 4.3) */
...
#define	ifr_brdaddr	ifr_ifru.ifru_broadaddr	/* other end of p-to-p link */
#define	ifr_broadaddr	ifr_ifru.ifru_broadaddr	/* other end of p-to-p link */
