...
total:
	...
	add.l	%d0, %a3
	addq.l	&1, %d1
	mulu.l	font_theight(%a1), %d1
	subq.l	&1, %d1
	mov.l	video_mem_x(%a2), %d0
	mov.l	video_scr_x(%a2), %d2
	sub.l	%d2, %d0
	lsr.l	&3, %d0
	lsr.l	&5, %d2
	subq.l	&1, %d2
